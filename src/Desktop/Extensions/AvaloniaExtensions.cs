...
public static class AvaloniaExtensions
{
    ...
    public static Theme ActualTheme(this Application application)
    {
        var actualThemeVariant = application.ActualThemeVariant;
        if (actualThemeVariant == ThemeVariant.Dark)
        {
            return Theme.Dark;
        }

        return actualThemeVariant == ThemeVariant.Light ? Theme.Light : Theme.System;
    }
}
