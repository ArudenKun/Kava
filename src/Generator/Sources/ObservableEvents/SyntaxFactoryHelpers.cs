...
namespace Generator.Sources.ObservableEvents;
...
internal static class SyntaxFactoryHelpers
{
    ...
    )
    {
        ...
        return SyntaxFactory
            .AccessorDeclaration(kind, attributesList, modifiersList, default, default)
            .WithSemicolonToken(Token(SyntaxKind.SemicolonToken));
    }
    ...
    )
    {
        ...
        var attributesList = List(attributes);
        return SyntaxFactory
            .AccessorDeclaration(kind, attributesList, modifiersList, body, default)
            .WithSemicolonToken(Token(SyntaxKind.SemicolonToken));
    }
    ...
    )
    {
        ...
        var attributesList = List(attributes);
        return SyntaxFactory
            .AccessorDeclaration(kind, attributesList, modifiersList, default, body)
            .WithSemicolonToken(Token(SyntaxKind.SemicolonToken));
    }
    ...
    )
    {
        ...
        return SyntaxFactory.AccessorList(
            Token(SyntaxKind.OpenBraceToken).AddTrialingSpaces().AddLeadingSpaces(),
            List(GetSpacedAccessors(accessors)),
            Token(SyntaxKind.CloseBraceToken).AddLeadingSpaces()
        );
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArgumentSyntax Argument(string argumentName) =>
        SyntaxFactory.Argument(IdentifierName(argumentName));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArgumentSyntax Argument(string argumentName, SyntaxToken refKind) =>
        SyntaxFactory.Argument(null, refKind, IdentifierName(argumentName));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArgumentSyntax Argument(string argumentName, string nameColon) =>
        SyntaxFactory.Argument(NameColon(nameColon), default, IdentifierName(argumentName));
    ...
    public static ArrayCreationExpressionSyntax ArrayCreationExpression(ArrayTypeSyntax type) =>
        SyntaxFactory.ArrayCreationExpression(
            SyntaxFactory.Token(SyntaxKind.NewKeyword).AddTrialingSpaces(),
            type,
            default
        );
    ...
    public static ArrayCreationExpressionSyntax ArrayCreationExpression(
        ...
        SyntaxFactory.ArrayCreationExpression(
            Token(SyntaxKind.NewKeyword).AddTrialingSpaces(),
            type,
            initializer
        );
    ...
    public static ArrayRankSpecifierSyntax ArrayRankSpecifier(
        OmittedArraySizeExpressionSyntax rank
    ) =>
        SyntaxFactory.ArrayRankSpecifier(
            SyntaxFactory.SingletonSeparatedList<ExpressionSyntax>(rank)
        );
    ...
    public static ArrayTypeSyntax ArrayType(
        ...
        IReadOnlyCollection<ArrayRankSpecifierSyntax> rankSpecifiers
    )
    {
        var rank =
            rankSpecifiers == null || rankSpecifiers.Count == 0
    ...
    ) => SyntaxFactory.AssignmentExpression(token, left, right);
    ...
    public static AssignmentExpressionSyntax AssignmentExpression(
        ...
        ExpressionSyntax left,
        string right
    ) => SyntaxFactory.AssignmentExpression(token, left, IdentifierName(right));
    ...
    public static AssignmentExpressionSyntax AssignmentExpression(
        ...
        string left,
        ExpressionSyntax right
    ) => SyntaxFactory.AssignmentExpression(token, IdentifierName(left), right);
    ...
    public static AssignmentExpressionSyntax AssignmentExpression(
        ...
        string left,
        string right
    ) => SyntaxFactory.AssignmentExpression(token, IdentifierName(left), IdentifierName(right));
    ...
    public static AttributeSyntax Attribute(
        string name,
        IReadOnlyCollection<AttributeArgumentSyntax>? arguments
    )
    {
        if (name == null)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AttributeArgumentSyntax AttributeArgument(
        NameEqualsSyntax nameEquals,
        ExpressionSyntax expression
    ) => SyntaxFactory.AttributeArgument(nameEquals, default, expression);
    ...
    public static AttributeListSyntax AttributeList(AttributeSyntax attribute) =>
        AttributeList(attribute, default);
    ...
    public static AttributeTargetSpecifierSyntax AttributeTargetSpecifier(SyntaxKind target) =>
        SyntaxFactory.AttributeTargetSpecifier(
            Token(target),
            Token(SyntaxKind.ColonToken).AddTrialingSpaces()
        );
    ...
    public static BaseListSyntax? BaseList(BaseTypeSyntax baseType) =>
        baseType == null
            ...
            : SyntaxFactory.BaseList(
                Token(SyntaxKind.ColonToken).AddLeadingSpaces().AddTrialingSpaces(),
                SingletonSeparatedList(baseType)
            );
    ...
    public static BinaryExpressionSyntax BinaryExpression(
        ...
        ExpressionSyntax left,
        ExpressionSyntax right
    ) => SyntaxFactory.BinaryExpression(kind, left.AddTrialingSpaces(), right.AddLeadingSpaces());
    ...
    public static BinaryExpressionSyntax BinaryExpression(
        ...
        string left,
        ExpressionSyntax right
    ) => BinaryExpression(kind, IdentifierName(left), right);
    ...
    public static BracketedArgumentListSyntax BracketedArgumentList(
        IReadOnlyCollection<ArgumentSyntax> nodes
    )
    {
        if (nodes == null || nodes.Count == 0)
        {
    ...
    )
    {
        ...
        GetTypeValues(
            ...
            bases,
            level,
            out var attributesList,
            out var name,
            out var modifiersList,
            out var baseList,
            out var membersList,
            out var typeParameterList,
            out var typeParameterConstraintList,
            out var openingBrace,
            out var closingBrace
        );
    ...
    public static ClassOrStructConstraintSyntax ClassOrStructConstraint(SyntaxKind syntaxKind) =>
        SyntaxFactory.ClassOrStructConstraint(syntaxKind);
    ...
    public static ConditionalAccessExpressionSyntax ConditionalAccessExpression(
        ...
        SyntaxFactory.ConditionalAccessExpression(
            expression,
            Token(SyntaxKind.QuestionToken).AddTrialingSpaces(),
            whenNotNull
        );
    ...
    )
    {
        ...
        var modifiersList =
            attributes?.Count > 0 ? TokenList(modifiers, level) : TokenList(modifiers);
    ...
    )
    {
        ...
        return SyntaxFactory.ConversionOperatorDeclaration(
            ...
            Token(SyntaxKind.OperatorKeyword).AddTrialingSpaces().AddLeadingSpaces(),
            typeName,
            parametersList,
            default,
            default,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DelegateDeclarationSyntax DelegateDeclaration(
        IReadOnlyCollection<AttributeListSyntax> attributes,
        IReadOnlyCollection<SyntaxKind> modifiers,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ElementAccessExpressionSyntax ElementAccessExpression(string expression) =>
        SyntaxFactory.ElementAccessExpression(IdentifierName(expression));
    ...
    public static EnumDeclarationSyntax EnumDeclaration(
        string identifier,
        IReadOnlyCollection<AttributeListSyntax> attributes,
        IReadOnlyCollection<EnumMemberDeclarationSyntax> members,
        IReadOnlyCollection<SyntaxKind> modifiers,
    ...
    )
    {
        ...
        var baseList = !string.IsNullOrWhiteSpace(baseIdentifier)
            ? BaseList(SimpleBaseType(IdentifierName(baseIdentifier)))
            : default;
    ...
    public static EqualsValueClauseSyntax EqualsValueClause(ExpressionSyntax value) =>
        SyntaxFactory.EqualsValueClause(
            SyntaxFactory.Token(SyntaxKind.EqualsToken).AddLeadingSpaces().AddTrialingSpaces(),
            value
        );
    ...
    )
    {
        var variableDeclaration = VariableDeclaration(
            ...
            SeparatedList([VariableDeclarator(eventName)])
        );
    ...
    )
    {
        ...
        return SyntaxFactory.EventFieldDeclaration(
            attributeList,
            modifiersList,
            SyntaxFactory.Token(SyntaxKind.EventKeyword).AddTrialingSpaces(),
            declaration,
    ...
    public static ExplicitInterfaceSpecifierSyntax ExplicitInterfaceSpecifier(string name) =>
        SyntaxFactory.ExplicitInterfaceSpecifier(IdentifierName(name));
    ...
    public static FieldDeclarationSyntax FieldDeclaration(
        ...
        IReadOnlyCollection<SyntaxKind>? modifiers,
        int level
    ) => FieldDeclaration(type, name, default, modifiers, level);
    ...
    public static FieldDeclarationSyntax FieldDeclaration(
        ...
        IReadOnlyCollection<SyntaxKind>? modifiers,
        int level
    ) => FieldDeclaration(type, name, Array.Empty<AttributeListSyntax>(), modifiers, level);
    ...
    )
    {
        var attributeList = List(attributes, level, true);
        var modifiersList =
            modifiers?.Count > 0 ? TokenList(modifiers, level) : TokenList(modifiers);

        var variableDeclaration = VariableDeclaration(
            type,
            SeparatedList([VariableDeclarator(name)])
        );
    ...
    )
    {
        ...
        var variableDeclaration = VariableDeclaration(
            type,
            SeparatedList([VariableDeclarator(name, initializer)])
        );
    ...
    public static IfStatementSyntax IfStatement(
        ExpressionSyntax conditionStatement,
        StatementSyntax statement
    ) =>
        SyntaxFactory.IfStatement(
            default,
            Token(SyntaxKind.IfKeyword).AddTrialingSpaces(),
            Token(SyntaxKind.OpenParenToken).AddTrialingSpaces(),
            conditionStatement,
            Token(SyntaxKind.CloseParenToken).AddTrialingSpaces(),
            statement,
            null
        );
    ...
    public static IfStatementSyntax IfStatement(
        ExpressionSyntax conditionStatement,
        StatementSyntax statement,
        ElseClauseSyntax elseStatement
    ) =>
        SyntaxFactory.IfStatement(
            default,
            Token(SyntaxKind.IfKeyword).AddTrialingSpaces(),
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InitializerExpressionSyntax InitializerExpression(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InvocationExpressionSyntax InvokeExplicitMethod(
        string className,
        string methodName,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InvocationExpressionSyntax InvokeMethod(
        string methodName,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArgumentSyntax LambdaAccessArgument(
        string variableName,
        MemberAccessExpressionSyntax members
    ...
    public static SyntaxList<TNode> List<TNode>(
        ...
        int level,
        bool lastNodeTrailingLine = false
    )
        where TNode : SyntaxNode
    {
        if (nodes == null || nodes.Count == 0)
    ...
    public static LiteralExpressionSyntax LiteralExpression(
        SyntaxKind syntaxKind,
        SyntaxToken token
    ) => SyntaxFactory.LiteralExpression(syntaxKind, token);
    ...
    public static LocalFunctionStatementSyntax LocalFunctionStatement(
        ...
        string functionName,
        IReadOnlyCollection<ParameterSyntax>? parameters,
        ArrowExpressionClauseSyntax? expressionBody = default,
    ...
    )
    {
        ...
        return SyntaxFactory.LocalFunctionStatement(
            default,
            default,
            IdentifierName(returnType).AddTrialingSpaces(),
    ...
    public static MemberAccessExpressionSyntax MemberAccess(
        ...
        (MemberAccessExpressionSyntax)
            identifierNames.Aggregate<string, ExpressionSyntax>(
                IdentifierName(startVariable),
                (expression, name) =>
                    MemberAccessExpression(
                        SyntaxKind.SimpleMemberAccessExpression,
                        expression,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MemberAccessExpressionSyntax MemberAccess(
        ExpressionSyntax startVariable,
        params string[] identifierNames
    ) =>
        (MemberAccessExpressionSyntax)
            identifierNames.Aggregate(
                startVariable,
                (expression, name) =>
                    MemberAccessExpression(
                        SyntaxKind.SimpleMemberAccessExpression,
    ...
    public static MemberAccessExpressionSyntax MemberAccessExpression(
        ...
        string name1,
        SimpleNameSyntax name
    ) => SyntaxFactory.MemberAccessExpression(kind, IdentifierName(name1), name);
    ...
    public static MemberAccessExpressionSyntax MemberAccessExpression(
        ...
        ExpressionSyntax expression,
        string name
    ) => SyntaxFactory.MemberAccessExpression(kind, expression, IdentifierName(name));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MemberBindingExpressionSyntax MemberBindingExpression(string name) =>
        SyntaxFactory.MemberBindingExpression(
            Token(SyntaxKind.DotToken).AddTrialingSpaces(),
            IdentifierName(name)
        );
    ...
    public static MethodDeclarationSyntax MethodDeclaration(
        ...
        IReadOnlyCollection<TypeParameterSyntax>? typeParameters,
        BlockSyntax? body,
        ArrowExpressionClauseSyntax? arrowSyntax,
        int level
    )
    {
        var name = SyntaxFactory.Identifier(identifier);
        ...
        var typeParameterList = TypeParameterList(typeParameters);
        var typeParameterConstraintList =
            typeParameterConstraintClauses?.Count > 0
                ? List(typeParameterConstraintClauses, level + 1)
                : default;
    ...
    )
    {
        ...
        var namespaceToken = createLeadingNewLine
            ? Token(SyntaxKind.NamespaceKeyword).AddLeadingNewLines()
            : Token(SyntaxKind.NamespaceKeyword);

        return SyntaxFactory.NamespaceDeclaration(
            namespaceToken,
            name,
            Token(SyntaxKind.OpenBraceToken).AddLeadingNewLines(),
            default,
            default,
            membersList,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static OmittedArraySizeExpressionSyntax OmittedArraySize() =>
    ...
    public static ParameterSyntax Parameter(string name) =>
        Parameter(default, default, default, name, default);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ParameterSyntax Parameter(
        string name,
        IReadOnlyCollection<SyntaxKind> modifier
    ) => Parameter(default, modifier, default, name, null);
    ...
    public static ParameterSyntax Parameter(
        ...
        string name,
        IReadOnlyCollection<SyntaxKind> modifier
    ) => Parameter(default, modifier, IdentifierName(type).AddTrialingSpaces(), name, null);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ParameterSyntax Parameter(string type, string name) =>
        Parameter(default, default, IdentifierName(type).AddTrialingSpaces(), name, null);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ParameterSyntax Parameter(
        string type,
        string name,
        EqualsValueClauseSyntax equals
    ) => Parameter(default, default, IdentifierName(type).AddTrialingSpaces(), name, equals);
    ...
    public static ParameterSyntax Parameter(
        ...
        string type,
        string name
    ) => Parameter(attributes, default, IdentifierName(type).AddTrialingSpaces(), name, null);
    ...
    public static ParameterSyntax Parameter(
        ...
        string name,
        EqualsValueClauseSyntax equals
    ) => Parameter(attributes, default, IdentifierName(type).AddTrialingSpaces(), name, equals);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ParameterSyntax Parameter(TypeSyntax type, string name) =>
        Parameter(default, default, type.AddTrialingSpaces(), name, null);
    ...
    public static ParameterSyntax Parameter(
        ...
        string name,
        IReadOnlyCollection<SyntaxKind> modifier
    ) => Parameter(default, modifier, type.AddTrialingSpaces(), name, null);
    ...
    public static ParenthesizedLambdaExpressionSyntax ParenthesizedLambdaExpression(
        BlockSyntax block
    ) => ParenthesizedLambdaExpression(default, block);
    ...
    )
    {
        ...
        return SyntaxFactory.ParenthesizedLambdaExpression(
            default,
            parameterList,
            Token(SyntaxKind.ArrowExpressionClause).AddTrialingSpaces().AddLeadingSpaces(),
            block
        );
    }
    ...
    )
    {
        ...
        return SyntaxFactory.ParenthesizedLambdaExpression(
            default,
            parameterList,
            Token(SyntaxKind.EqualsGreaterThanToken).AddTrialingSpaces().AddLeadingSpaces(),
            block
        );
    }
    ...
    {
        var readOnlySyntax = isReadOnly
            ? Token(SyntaxKind.ReadOnlyKeyword).AddTrialingSpaces()
            : Token(SyntaxKind.None);
        return SyntaxFactory.RefType(
            Token(SyntaxKind.RefKeyword).AddTrialingSpaces(),
            readOnlySyntax,
            type
        );
    }
    ...
    public static ReturnStatementSyntax ReturnStatement(ExpressionSyntax expression) =>
        SyntaxFactory.ReturnStatement(
            default,
            Token(SyntaxKind.ReturnKeyword).AddTrialingSpaces(),
            expression,
            Token(SyntaxKind.SemicolonToken)
        );

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReturnStatementSyntax ReturnStatement(string value) =>
        SyntaxFactory.ReturnStatement(
            default,
            Token(SyntaxKind.ReturnKeyword).AddTrialingSpaces(),
        ...
        where TNode : SyntaxNode
    {
        ...
        var commaSeparation = Enumerable.Repeat(
            Token(SyntaxKind.CommaToken).AddTrialingSpaces(),
            nodes.Count - 1
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SeparatedSyntaxList<EnumMemberDeclarationSyntax> SeparatedList(
        IReadOnlyCollection<EnumMemberDeclarationSyntax> nodes,
        int level
    )
    {
        if (nodes == null || nodes.Count == 0)
    ...
    public static SimpleBaseTypeSyntax SimpleBaseType(string type) =>
        SyntaxFactory.SimpleBaseType(IdentifierName(type));
    ...
    public static SyntaxTokenList TokenList(IReadOnlyCollection<SyntaxKind>? tokens, int level)
    {
        ...
        foreach (var token in tokens)
        {
            items.Add(
                i == 0
                    ? Token(token)
                        .AddLeadingSpaces(level * LeadingSpacesPerLevel)
                        .AddTrialingSpaces()
                    : Token(token).AddTrialingSpaces()
            );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TupleElementSyntax TupleElement(string type, string name) =>
        TupleElement(IdentifierName(type), name);
    ...
    public static TypeParameterSyntax TypeParameter(string identifier) =>
        TypeParameter(default, default, identifier);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypeParameterSyntax TypeParameter(
        IReadOnlyCollection<AttributeListSyntax>? attributes,
        SyntaxKind varianceKind,
        string identifier
    )
    {
        var name = Identifier(identifier);
        var varianceKeyword =
            varianceKind == SyntaxKind.None ? default : Token(varianceKind).AddTrialingSpaces();
        var attributesList = List(attributes);
    ...
    public static TypeParameterConstraintClauseSyntax TypeParameterConstraintClause(
        string name,
        IReadOnlyCollection<TypeParameterConstraintSyntax> constraints
    )
    {
        var constraintsList = SeparatedList(constraints);
        return SyntaxFactory.TypeParameterConstraintClause(
            Token(SyntaxKind.WhereKeyword).AddLeadingSpaces().AddTrialingSpaces(),
            IdentifierName(name),
            Token(SyntaxKind.ColonToken).AddLeadingSpaces().AddTrialingSpaces(),
            constraintsList
        );
    ...
    public static TypeParameterListSyntax? TypeParameterList(
        IReadOnlyCollection<TypeParameterSyntax>? parameters
    )
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UsingDirectiveSyntax UsingDirective(string identifier) =>
        SyntaxFactory.UsingDirective(
            Token(SyntaxKind.UsingKeyword).AddTrialingSpaces(),
            default,
            null,
            IdentifierName(identifier),
            Token(SyntaxKind.SemicolonToken).AddTrialingNewLines()
        );
    ...
    public static VariableDeclarationSyntax VariableDeclaration(
        TypeSyntax type,
        IReadOnlyCollection<VariableDeclaratorSyntax> variableDeclaratorSyntaxes
    )
    {
    ...
    )
    {
        ...
        return SyntaxFactory.VariableDeclaration(
            IdentifierName(type).AddTrialingSpaces(),
            variableDeclaratorList
        );
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static VariableDeclarationSyntax VariableDeclaration(string type) =>
        SyntaxFactory.VariableDeclaration(IdentifierName(type), default);
    ...
    public static PredefinedTypeSyntax Void() =>
        SyntaxFactory.PredefinedType(Token(SyntaxKind.VoidKeyword));
    ...
    {
        var openingBrace = Token(SyntaxKind.OpenBraceToken)
            .AddLeadingNewLinesAndSpaces(1, level * LeadingSpacesPerLevel);
        var closingBrace = Token(SyntaxKind.CloseBraceToken)
            .AddLeadingNewLinesAndSpaces(1, level * LeadingSpacesPerLevel);
    ...
    {
        var openingBrace = Token(SyntaxKind.OpenBracketToken)
            .AddLeadingNewLinesAndSpaces(1, level * LeadingSpacesPerLevel);
        var closingBrace = Token(SyntaxKind.CloseBracketToken)
            .AddLeadingNewLinesAndSpaces(1, level * LeadingSpacesPerLevel);
    ...
    private static IReadOnlyCollection<T> GetIndentedNodes<T>(
        IReadOnlyCollection<T> modifiers,
        int level,
        bool lastNodeTrailingLine = false
    )
        where T : SyntaxNode
    {
        ...
        {
            var addModifier = modifier.AddLeadingNewLinesAndSpaces(
                1,
                level * LeadingSpacesPerLevel
            );
    ...
    private static IReadOnlyCollection<AccessorDeclarationSyntax> GetSpacedAccessors(
        IReadOnlyCollection<AccessorDeclarationSyntax> accessors
    )
    {
        var i = 0;
    ...
    private static void GetTypeValues(
        string identifier,
        IReadOnlyCollection<AttributeListSyntax>? attributes,
        IReadOnlyCollection<SyntaxKind>? modifiers,
        IReadOnlyCollection<MemberDeclarationSyntax>? members,
        ...
        IReadOnlyCollection<BaseTypeSyntax>? bases,
        int level,
        out SyntaxList<AttributeListSyntax> attributeList,
        out SyntaxToken name,
        out SyntaxTokenList modifiersList,
        out BaseListSyntax? baseList,
        out SyntaxList<MemberDeclarationSyntax> membersList,
        out TypeParameterListSyntax? typeParameterList,
        out SyntaxList<TypeParameterConstraintClauseSyntax> typeParameterConstraintList,
        out SyntaxToken openingBrace,
        out SyntaxToken closingBrace
    )
    {
        ...
        typeParameterConstraintList =
            typeParameterConstraintClauses?.Count > 0
                ? List(typeParameterConstraintClauses)
                : default;
