...
namespace Kava.Generators.Sources.ObservableEvents.EventGenerators.Comparers;

/// <summary>
/// A comparer which will compare <see cref="INamedTypeSymbol"/> names.
/// </summary>
internal class TypeDefinitionNameComparer
        ...
        IComparer<INamedTypeSymbol>
{
    ...
    public bool Equals(INamedTypeSymbol? x, INamedTypeSymbol? y)
    {
        return StringComparer.Ordinal.Equals(
            x?.GenerateFullGenericName(),
            y?.GenerateFullGenericName()
        );
    }
