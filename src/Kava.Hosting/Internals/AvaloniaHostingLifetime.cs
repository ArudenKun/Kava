...
namespace Kava.Hosting.Internals;

internal sealed class AvaloniaHostingLifetime<TApplication> : IHostLifetime
    where TApplication : Application
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AvaloniaHostingLifetime{TApplication}"/> class.
    /// </summary>
    public AvaloniaHostingLifetime(
